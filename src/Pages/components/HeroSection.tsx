...
const HeroSection = () => {
  ...
  <div
  key={stat.name}
  className="flex flex-col items-center justify-center rounded-2xl bg-white/10 backdrop-blur-md border border-white/20 p-6 shadow-lg transition-all hover:scale-105 hover:shadow-2xl hover:border-cyan-400"
  data-aos="flip-left"
  data-aos-delay={200 * index}
>
  {/* Stat Number */}
