  ...
  return (
    <div className="relative isolate overflow-hidden bg-slate-950 py-24 sm:py-32">
      ...
      <div className="mx-auto max-w-2xl lg:mx-0" data-aos="fade-up" data-aos-duration="1200">
        <p className="text-sm font-semibold tracking-tight bg-gradient-to-r from-cyan-400 via-pink-400 to-purple-400 text-transparent bg-clip-text sm:text-sm"> 👋 Hello i am</p>
  <h2 className="text-5xl font-semibold tracking-tight text-sky-400 sm:text-7xl">
     Muichiro
  </h2>
  <div className="grid">
    <p className="mt-8 text-lg font-medium text-pretty text-sky-400 sm:text-xl/8" data-aos="fade-up" data-aos-delay="300">
        ...
        >
          ...
          >
            {stats.map((stat, index) => (
              <div
  key={stat.name}
  className="flex flex-col items-center justify-center text-center rounded-2xl bg-white/10 backdrop-blur-md border border-white/20 p-6 shadow-lg transition-all hover:scale-105 hover:shadow-2xl hover:border-cyan-400 w-full max-w-md mx-auto"
  data-aos="flip-left"
  data-aos-delay={200 * index}
>
  {/* Stat Number */}
  <dd className="text-5xl font-extrabold text-white drop-shadow-md">
    {stat.value}
  </dd>
