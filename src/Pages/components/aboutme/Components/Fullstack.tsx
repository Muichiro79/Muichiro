...
const Fullstack = () => {
    ...
    return (
        <div className="bg-slate-900 p-8 rounded-lg shadow-lg  transition-transform duration-300" data-aos="zoom-in">
            <h2 className="text-3xl font-bold text-cyan-400 text-center">Full-Stack Development</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-6">
                {fullStackTools.map((tool) => (
                    <div key={tool.name} className="group bg-slate-800 p-6 rounded-xl shadow-md hover:shadow-cyan-500/50 hover:scale-105 transition-all duration-500 ease-in-out text-center text-white flex flex-col items-center justify-center">
