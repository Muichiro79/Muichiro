...
import { SiPostman, SiVercel, SiNetlify, SiFirebase, SiMongodb, SiTypescript, SiWebpack } from "react-icons/si";
...
const Others = () => {
  const otherTools = [
    { name: "Git & GitHub", icon: <FaGithub />, color: "text-gray-800 dark:text-white" },
    ...
    { name: "SQL", icon: <GrMysql />, color: "text-blue-600" },
    { name: "REST APIs", icon: <MdApi />, color: "text-indigo-500" },
    { name: "Webpack", icon: <SiWebpack />, color: "text-sky-500" },
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
        {otherTools.map((tool) => (
          ...
          >
            ...
            <div className="relative w-16 h-16 flex items-center justify-center rounded-full bg-gradient-to-tr from-purple-200/40 to-pink-400/10 dark:from-purple-600/20 dark:to-pink-500/10 mb-3 group-hover:scale-110 transition-transform duration-300">
