...
const Others = () => {
  ...
  return (
    ...
    <h2 className="text-3xl font-bold text-emerald-400 text-center">Other Skills</h2>
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-6">
        {Others.map((tool) => (
            <div key={tool.name} className="group bg-slate-800 p-6 rounded-xl shadow-md hover:shadow-emerald-500/50 hover:scale-105 transition-all duration-500 ease-in-out text-center text-white flex flex-col items-center justify-center">
